...
## 🛠️ Detalhes das Atualizações Recentes

- 🎭 **Nova Forja Rúnica:** Seção dedicada para mudar de avatar, título e visual real de herói medieval diretamente de sua carteira de progresso.
- 📜 **Aprimoramentos de Visual:** Adornamos os cabeçalhos com o sagrado Livro do Conhecimento e o Pergaminho Antigo em pixel arte de alta qualidade.
- 🏆 **Salão de Classificação:** Acesse o Hall da Fama e compare seus pontos com os demais sábios em tempo real.
